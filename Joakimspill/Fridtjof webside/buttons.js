function controls(){
  document.getElementById('howto').src ="sprites/Controls.png";
  document.getElementById("controls").style.backgroundColor = "#E6F911";
...
function items(){
  document.getElementById('howto').src ="sprites/Items.png";
  document.getElementById("controls").style.backgroundColor = "#13572F";
  document.getElementById("controls").style.color = "#ffffff";
  document.getElementById("items").style.backgroundColor = "#E6F911";
  document.getElementById("items").style.color = "#23272a";
  document.getElementById("enemies").style.backgroundColor = "#13572F";
  document.getElementById("enemies").style.color = "#ffffff";
}
function enemies(){
  document.getElementById('howto').src ="sprites/Enemies.png";
  document.getElementById("controls").style.backgroundColor = "#13572F";
  document.getElementById("controls").style.color = "#ffffff";
  document.getElementById("items").style.backgroundColor = "#13572F";
  document.getElementById("items").style.color = "#ffffff";
  document.getElementById("enemies").style.backgroundColor = "#E6F911";
